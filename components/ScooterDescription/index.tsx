...
export const ScooterDescription: React.FC<ScooterDescriptionProps> = ({
  open,
  scooter,
  handleClose,
}) => {
  return (
    ...
    >
      <div
        className="right-0 w-100 mt-2 bg-white divide-y divide-gray-100 rounded-md focus:outline-none"
        role="menu"
      >
